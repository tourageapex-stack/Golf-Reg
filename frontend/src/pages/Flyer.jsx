  ...
  return (
    <div className="min-h-screen bg-slate-100">
            ...
            <div className="relative flex items-center justify-between gap-6 flex-wrap">
              ...
              <div className="flex-1 min-w-[200px] max-w-md">
                ...
                <p className="text-xs text-white/70 mt-2 text-right">
                  {spotsFilled} of {TOTAL_SPOTS} players registered · {info.current_teams || 0} of {TOTAL_TEAMS} teams
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="py-8 print:py-0">
        ...
        >
          {/* Top Band */}
          <div className="bg-gradient-to-br from-[#1a365d] via-[#0f2342] to-[#1a365d] px-10 pt-4 pb-4 relative">
            {/* Decorative accents */}
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-[#f7dc00] font-bold uppercase tracking-widest text-[10px] mb-1">
                  ILWU Local 4 Presents
                </p>
                <h1 className="font-heading text-3xl font-bold text-white uppercase leading-none tracking-tight">
                  Golf
                </h1>
                <h1 className="font-heading text-3xl font-bold text-[#f7dc00] uppercase leading-none tracking-tight mt-1">
                  Tournament
                </h1>
          ...
          <div className="px-10 py-6 space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-3 gap-2 w-[90%]">
                <div className="border-2 border-[#f7dc00] bg-[#f7dc00]/10 rounded-lg p-2 flex flex-col justify-center">
                  <p className="text-[9px] font-bold uppercase tracking-widest text-[#1a365d]/70">Early Bird</p>
                  <p className="font-heading text-2xl font-bold text-[#1a365d]">$125</p>
                  <p className="text-[10px] text-[#1a365d]/80 mt-0.5">per player · before June 20</p>
                </div>
                <div className="border-2 border-slate-300 bg-slate-50 rounded-lg p-2 flex flex-col justify-center">
                  <p className="text-[9px] font-bold uppercase tracking-widest text-slate-500">Regular</p>
                  <p className="font-heading text-2xl font-bold text-slate-700">$150</p>
                  <p className="text-[10px] text-slate-600 mt-0.5">per player · starting June 20</p>
                </div>
                <div className="bg-[#1a365d] text-[#f7dc00] rounded-lg p-2 flex flex-col items-center justify-center text-center shadow-md" data-testid="lunch-callout">
                  <Gift className="h-6 w-6 mb-1" />
                  <span className="font-bold uppercase tracking-wide text-[10px] leading-tight">Lunch<br/>Provided</span>
                  <span className="text-[8px] mt-1 opacity-80 leading-tight">Included<br/>with Entry</span>
                </div>
              </div>
            ...
            <section className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-1.5 w-5/6">
              ...
              <div>
                ...
                <ul className="space-y-1.5 w-5/6">
                  <li className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5">
                    ...
                    <div>
                      <p className="font-bold text-sm text-[#1a365d]">Long Drive Contest</p>
                  ...
                  <li className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5">
                    ...
                    <div>
                      <p className="font-bold text-sm text-[#1a365d]">Closest to the Pin</p>
                  ...
                  <li className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5">
                    ...
                    <div>
                      <p className="font-bold text-sm text-[#1a365d]">Raffle Prizes</p>
                  ...
                  <li className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5">
                    ...
                    <div>
                      <p className="font-bold text-sm text-[#1a365d]">Mulligans</p>
            ...
            <section className="grid grid-cols-2 gap-6">
              <div>
                ...
                <ol className="space-y-2 text-sm text-slate-700">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span><strong>Pay Online</strong> or <strong>Credit Union</strong></span>
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <div className="text-sm text-slate-700 space-y-2">
                  <p><strong className="text-[#1a365d]">Pay Online (Preferred)</strong> or at the <strong className="text-[#1a365d]">Credit Union</strong></p>
          ...
          {/* Footer Band with QR */}
          <div className="bg-[#1a365d] px-10 py-4 flex items-center justify-between gap-6 text-white mt-auto">
            <div className="flex items-center gap-4">
              <div className="bg-white p-2 rounded-lg shrink-0" data-testid="flyer-qr">
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent(SITE_URL)}`}
